...
#  Project:            SPAR
#  Authors:            Jill
#  Description:        Test for test_utils
# *****************************************************************
import sys
import os
import unittest
...
class TestUtilsTest(unittest.TestCase):
    '''Test class for testing the test_utils functions'''
    ...
    def test_id_generator(self):
        '''Test id generator'''
        idgen1 = tu.IDGenerator()
        test_id1 = idgen1.get_id()
        self.assertEqual(test_id1, "00001")
        test_id2 = idgen1.get_id()
        self.assertEqual(test_id2, "00002")
        idgen2 = tu.IDGenerator(10000)
        test_id3 = idgen2.get_id()
        self.assertEqual(test_id3, "10001")
        test_id4 = idgen2.get_id()
        self.assertEqual(test_id4, "10002")

    def test_get_dbsize_string(self):
        '''Test converting db size to string'''
        val = tu.get_dbsize_string(1000000, 1000)
        self.assertEqual(val, "1krows_1MBpr")

    def test_get_db_size(self):
        '''Test getting db size info'''
        (record_size, num_records) = tu.get_db_size(self.resultdb)
        self.assertEqual(record_size, 1003)
        self.assertEqual(num_records, 30)
