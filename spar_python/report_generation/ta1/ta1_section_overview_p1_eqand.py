...
class Ta1OverviewP1EqAndSection(t1soc.Ta1OverviewCommonSection):
    """The Equality-And overview section of the TA1 report."""
    ...
    def __init__(self, jinja_template, report_generator):
        ...
        subcat = t1s.SUBCATEGORIES[cat].eqand
        super(Ta1OverviewP1EqAndSection, self).__init__(
    ...
    def _get_parameters(self, selection_cols):
        ...
        parameters["values"] =  self._config.results_db.get_query_values(
            [(t1s.DBP_TABLENAME, t1s.DBP_NUMNEWRETURNEDRECORDS),
             ...
             (t1s.DBF_TABLENAME, t1s.DBF_P1ANDNUMRECORDSMATCHINGFIRSTTERM)],
            constraint_list=this_constraint_list)
        parameters["ftr"] = self._config.ql_p1and_ftr
        return parameters
