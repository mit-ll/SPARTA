...
class Ta1QueryCorrectnessSection(section.Ta1Section):
    """The query correctness section of the TA1 report"""
    ...
    def _store_query_correctness_table(self):
        ...
        def add_content(table, cat_string, subcat_string, correctness_getter):
            ...
            table.add_content([
                ...
                str(correctness_getter.get_num_failed())])
