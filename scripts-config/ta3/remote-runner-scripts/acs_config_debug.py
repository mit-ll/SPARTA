...
# NOTE This requires ACS' debugging software to be running
server.args.extend(["--serving=" + server.host, 
                    "--schema=" + remote_schema_path, 
                    "--logging=10.10.10.214:51401"])
...
# quotes.
client.args.extend(["--logging=10.10.10.214:51401", 
                    "--serving=" + server.host, 
                    "client%n"])
