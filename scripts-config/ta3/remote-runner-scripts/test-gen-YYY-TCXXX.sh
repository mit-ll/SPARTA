...
performer='TBD'
testname='TCXXX'
num_clients=10                 # Number of subscribers. Default: 5. ROE variable n.
num_pubs=100                   # Number of publications. 
...
disjunction_size='CONSTANT 1'
unique_matches='POISSON 2'     # Default: 'POISSON 2' (ROE variable beta) 
...
num_pubs_per_conj=0            # Used only for mixed pub-sub tests. Default: 0.
test_script_dir='/home/lincoln/trunk/scripts-config/ta3/test-scripts'
archive_dir='/home/lincoln/spar-archive'
runner_dir='/home/lincoln/trunk/scripts-config/ta3/remote-runner-scripts'
fields_dir='/home/lincoln/spar-fields'
generator_path='/home/lincoln/trunk/cpp/test-harness/ta3/pub-sub-gen/opt/ta3-test-generator'
log_collector_dir='/home/lincoln/trunk/scripts-config/common/scripts'
...
sleep 1
cd $runner_dir
script -c "python remote_runner.py -c ${performer}_config.py -m ${performer}-${testname}_muddler.py -u lincoln -p SPARtest -l WARNING" $archive_dir/$testname/rr_log.txt
