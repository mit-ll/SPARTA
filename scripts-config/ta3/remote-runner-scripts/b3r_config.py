...
tp.args.extend(["ThirdPartyBroker.jar", "-h", tp.host])
tp.files[LOCAL_JAR_DIR + "ThirdPartyBroker.jar"] = \
         "ThirdPartyBroker.jar"
tp.num_cores = 1
...
server.args.extend(["PublishingServer.jar",
                    "-f", REMOTE_CONFIG_DIR + "metadata_schema.csv",
                    "-h", tp.host])
server.files[LOCAL_JAR_DIR + "PublishingServer.jar"] = \
             "PublishingServer.jar"
server.num_cores = 1
# =============================================================================
...
# quotes.
client.args.extend(["SubscribingClient.jar", "-n", "%n", "-h", tp.host])
