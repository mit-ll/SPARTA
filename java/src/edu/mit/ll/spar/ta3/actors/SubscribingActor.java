 ...
 */
public abstract class SubscribingActor extends PubSubActor {
    /**
     ...
     */
    public abstract String subscribe(final int subId, final String subRule);
    public abstract String unsubscribe(final int subId);
}
